...
execute if score game.mode.ffa.win flag matches 1 run function slug_arena:game-on/execute/win-conditions/modes/ffa
...
execute if score game.mode.2v2.win flag matches 1 run function slug_arena:game-on/execute/win-conditions/modes/2v2
