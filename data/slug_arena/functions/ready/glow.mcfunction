#### North ####
# Off
execute if score ready.north variable matches 0 run team remove north.ready
execute if score ready.north variable matches 0 run effect clear @a[tag=player.north] minecraft:glowing
...
execute if score ready.north variable matches 1 run effect give @a[tag=player.north] minecraft:glowing infinite 1 true


### South ####
# Off
execute if score ready.south variable matches 0 run team remove south.ready
execute if score ready.south variable matches 0 run effect clear @a[tag=player.south] minecraft:glowing
...
execute if score ready.south variable matches 1 run effect give @a[tag=player.south] minecraft:glowing infinite 1 true


### East ####
# Off
execute if score ready.east variable matches 0 run team remove east.ready
execute if score ready.east variable matches 0 run effect clear @a[tag=player.east] minecraft:glowing
...
execute if score ready.east variable matches 1 run effect give @a[tag=player.east] minecraft:glowing infinite 1 true


### West ####
# Off
execute if score ready.west variable matches 0 run team remove west.ready
execute if score ready.west variable matches 0 run effect clear @a[tag=player.west] minecraft:glowing
...
execute if score ready.west variable matches 1 run effect give @a[tag=player.west] minecraft:glowing infinite 1 true