...
execute if score door var-game matches 219 run particle smoke 313.0 99.0 -108.4 2 0 0.1 0.05 500

execute if score door var-game matches 219 run particle smoke 313.0 99.0 -36.6 2 0 0.1 0.05 500
execute if score door var-game matches 219 run particle smoke 313.0 99.0 -38.1 2 0 0.1 0.05 500

execute if score door var-game matches 219 run particle smoke 348.4 99.0 -73.0 0.1 0 2 0.05 500
execute if score door var-game matches 219 run particle smoke 346.9 99.0 -73.0 0.1 0 2 0.05 500

execute if score door var-game matches 219 run particle smoke 276.6 99.0 -73.0 0.1 0 2 0.05 500
execute if score door var-game matches 219 run particle smoke 278.1 99.0 -73.0 0.1 0 2 0.05 500