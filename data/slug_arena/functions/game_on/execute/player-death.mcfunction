...
## Kill slugs (Will not kill in KotH)
execute unless score mode var-game matches 2 if score north var-death matches 1 as @e[name=Green, type=#slugterra:slug] run tp @s 0 0 0
execute unless score mode var-game matches 2 if score north var-death matches 1 as @e[name=Green, type=#slugterra:velocimorph] run tp @s 0 0 0
execute unless score mode var-game matches 2 if score north var-death matches 1 as @e[name=Green, type=#slugterra:velocimorphabilityentity] run tp @s 0 0 0
execute unless score mode var-game matches 2 if score north var-death matches 1 run kill @e[name=Green, type=#slugterra:slug]
execute unless score mode var-game matches 2 if score north var-death matches 1 run kill @e[name=Green, type=#slugterra:velocimorph]
execute unless score mode var-game matches 2 if score north var-death matches 1 run kill @e[name=Green, type=#slugterra:velocimorphabilityentity]

execute unless score mode var-game matches 2 if score south var-death matches 1 as @e[name=Yellow, type=#slugterra:slug] run tp @s 0 0 0
execute unless score mode var-game matches 2 if score south var-death matches 1 as @e[name=Yellow, type=#slugterra:velocimorph] run tp @s 0 0 0
execute unless score mode var-game matches 2 if score south var-death matches 1 as @e[name=Yellow, type=#slugterra:velocimorphabilityentity] run tp @s 0 0 0
execute unless score mode var-game matches 2 if score south var-death matches 1 run kill @e[name=Yellow, type=#slugterra:slug]
execute unless score mode var-game matches 2 if score south var-death matches 1 run kill @e[name=Yellow, type=#slugterra:velocimorph]
execute unless score mode var-game matches 2 if score south var-death matches 1 run kill @e[name=Yellow, type=#slugterra:velocimorphabilityentity]

execute unless score mode var-game matches 2 if score east var-death matches 1 as @e[name=Red, type=#slugterra:slug] run tp @s 0 0 0
execute unless score mode var-game matches 2 if score east var-death matches 1 as @e[name=Red, type=#slugterra:velocimorph] run tp @s 0 0 0
execute unless score mode var-game matches 2 if score east var-death matches 1 as @e[name=Red, type=#slugterra:velocimorphabilityentity] run tp @s 0 0 0
execute unless score mode var-game matches 2 if score east var-death matches 1 run kill @e[name=Red, type=#slugterra:slug]
execute unless score mode var-game matches 2 if score east var-death matches 1 run kill @e[name=Red, type=#slugterra:velocimorph]
execute unless score mode var-game matches 2 if score east var-death matches 1 run kill @e[name=Red, type=#slugterra:velocimorphabilityentity]

execute unless score mode var-game matches 2 if score west var-death matches 1 as @e[name=Blue, type=#slugterra:slug] run tp @s 0 0 0
execute unless score mode var-game matches 2 if score west var-death matches 1 as @e[name=Blue, type=#slugterra:velocimorph] run tp @s 0 0 0
execute unless score mode var-game matches 2 if score west var-death matches 1 as @e[name=Blue, type=#slugterra:velocimorphabilityentity] run tp @s 0 0 0
execute unless score mode var-game matches 2 if score west var-death matches 1 run kill @e[name=Blue, type=#slugterra:slug]
execute unless score mode var-game matches 2 if score west var-death matches 1 run kill @e[name=Blue, type=#slugterra:velocimorph]
execute unless score mode var-game matches 2 if score west var-death matches 1 run kill @e[name=Blue, type=#slugterra:velocimorphabilityentity]
