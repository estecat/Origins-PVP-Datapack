...
## Execution
execute as @a[x=312,y=29,z=-282,distance=..5] unless score game.start variable matches 1 unless entity @s[tag=player,gamemode=adventure] run function slug_arena:options/execute
