...
clone 512 6 -59 580 11 9 278 97 -107
clone 512 12 -59 580 17 9 278 103 -107
clone 512 18 -59 580 23 9 278 109 -107
clone 512 24 -59 580 29 9 278 115 -107
clone 512 30 -59 580 35 9 278 121 -107
clone 512 36 -59 580 41 9 278 127 -107
clone 512 42 -59 580 47 9 278 133 -107
...
# End
scoreboard players set map var-game 5
data modify storage slug_arena:settings map set value "§2Jungle Ruins"