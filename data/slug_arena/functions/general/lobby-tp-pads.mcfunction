...
execute as @a positioned 311 29 -319 if entity @s[dx=1,dz=1,tag=!lobby-pad.in] run tp @s 410 23 -265 0 0

# Command Plate
execute as @a positioned 335 34 -294 if entity @s[dx=1,dz=1,tag=!lobby-pad.in] run tag @s add lobby-pad.out
execute as @a positioned 335 34 -294 if entity @s[dx=1,dz=1,tag=!lobby-pad.in] run tp @s 312 -63 -73 0 0
...
execute as @a positioned 409 23 -266 if entity @s[dx=1,dz=1,tag=!lobby-pad.out] run tp @s 312 29 -318 0 0

# Command Plate
execute as @a positioned 311 -63 -74 if entity @s[dx=1,dz=1,tag=!lobby-pad.out] run tag @s add lobby-pad.in
execute as @a positioned 311 -63 -74 if entity @s[dx=1,dz=1,tag=!lobby-pad.out] run tp @s 336 34 -293 90 0
