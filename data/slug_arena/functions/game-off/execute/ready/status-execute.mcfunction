...
execute if entity @a[tag=player.north,x=310,y=98,z=-111,dx=4,dy=2,dz=2] run scoreboard players set ready.north variable 1
execute if entity @a[tag=player.south,x=310,y=98,z=-37,dx=4,dy=2,dz=2] run scoreboard players set ready.south variable 1
execute if entity @a[tag=player.east,x=348,y=98,z=-75,dx=2,dy=2,dz=4] run scoreboard players set ready.east variable 1
execute if entity @a[tag=player.west,x=274,y=98,z=-75,dx=2,dy=2,dz=4] run scoreboard players set ready.west variable 1
