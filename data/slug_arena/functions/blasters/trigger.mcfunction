...
# Refresh
execute as @a[tag=player.north] if score @s pages matches 1..2 unless score north-chose var-blaster matches 1 run scoreboard players set north-refresh var-blaster 1
execute as @a[tag=player.south] if score @s pages matches 1..2 unless score south-chose var-blaster matches 1 run scoreboard players set south-refresh var-blaster 1
execute as @a[tag=player.east] if score @s pages matches 1..2 unless score east-chose var-blaster matches 1 run scoreboard players set east-refresh var-blaster 1
execute as @a[tag=player.west] if score @s pages matches 1..2 unless score west-chose var-blaster matches 1 run scoreboard players set west-refresh var-blaster 1

# Sound
execute as @a[tag=player.north] if score @s pages matches 1..2 unless score north-chose var-blaster matches 1 run playsound minecraft:item.book.page_turn master @s 303 100 -114
execute as @a[tag=player.south] if score @s pages matches 1..2 unless score south-chose var-blaster matches 1 run playsound minecraft:item.book.page_turn master @s 321 99 -32
execute as @a[tag=player.east] if score @s pages matches 1..2 unless score east-chose var-blaster matches 1 run playsound minecraft:item.book.page_turn master @s 353 100 -82
execute as @a[tag=player.west] if score @s pages matches 1..2 unless score west-chose var-blaster matches 1 run playsound minecraft:item.book.page_turn master @s 271 100 -64
